        ...
        {onLaunch && (
          <button
            ...
            style={{
              ...
              alignItems: "center",
              gap: 8,
              boxShadow: "0 0 20px rgba(245,158,11,0.55), 0 4px 14px rgba(0,0,0,0.4)",
              transition: "transform 0.2s ease, box-shadow 0.2s ease",
            }}
            onMouseOver={(e) => {
              e.currentTarget.style.transform = "scale(1.04)"
              e.currentTarget.style.boxShadow = "0 0 28px rgba(245,158,11,0.8)"
            }}
            onMouseOut={(e) => {
